...
import { ArrowLeft, User, Calendar, CreditCard, Shield } from 'lucide-react';
        ...
        <DashboardLayout>
            <div className="max-w-2xl mx-auto space-y-6">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold">{t('members.addNewSubscription')}</h1>
                    ...
                    <div className="space-y-6">
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>Select a subscription plan for this member</CardDescription>
                            </CardHeader>
                        ...
                        <div className="flex gap-4">
                            ...
                            >
                                {submitting ? t('common.processing') : t('members.addSubscription')}
                            </Button>
                        </div>
                    </div>
                </form>
